...
namespace DataSync.DBUtility
{
    public abstract class DbHelperSQL
    {
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        public static string connectionString = ConfigurationManager.ConnectionStrings["DAConnectionString"].ConnectionString;
        public static string u8connectionString = ConfigurationManager.ConnectionStrings["U8ConnectionString"].ConnectionString;
        public DbHelperSQL() { }
        ...
        /// <returns></returns>
        public static object ExecuteScalar(string sql, string cmdParms)
        {
            return null;
